...
def test_mapathon_osm_history_query_builder():
    ...
    changeset_query, hashtag_filter, timestamp_filter = query_builder.create_changeset_query(
        params, con, cur)
    result_osm_history_query = query_builder.create_osm_history_query(
...
def test_mapathon_users_contributors_query_builder():
    ...
    params = validation.MapathonRequestParams(**test_param)
    changeset_query, _, _ = query_builder.create_changeset_query(params, con,
                                                       cur)
    result_users_contributors_query = query_builder.create_users_contributions_query(
