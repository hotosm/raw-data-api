...
def test_mapathon_total_contributor_mapathon_query_builder():
    ...
    assert result_total_contributor_query.encode('utf-8') == default_total_contributor_query
...
def test_mapathon_users_contributors_mapathon_query_builder():
    ...
    assert result_users_contributors_query.encode('utf-8') == default_users_contributors_query
