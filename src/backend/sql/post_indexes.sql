...
CREATE INDEX IF NOT EXISTS nodes_h3_idx  ON public.nodes(h3);
CREATE INDEX IF NOT EXISTS ways_line_h3_idx ON public.ways_line(h3);
CREATE INDEX IF NOT EXISTS ways_poly_h3_idx ON public.ways_poly(h3);
CREATE INDEX IF NOT EXISTS relations_h3_idx ON public.relations(h3);
